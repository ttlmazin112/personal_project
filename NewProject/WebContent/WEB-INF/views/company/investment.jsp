...
<li><a href="investment2.do">업계비교</a></li>
	...
	<div id="column_chart_div1" style="width: 600px; height: 400px; margin: 0px 300px;" ></div>
	
	<div id="line_chart_div1" style="width: 900px; height: 500px; margin: auto auto;"></div>
