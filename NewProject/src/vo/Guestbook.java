...
public class Guestbook
{
	...
	public String toString() {
		return "Guestbook [guestbook_no=" + guestbook_no + ", guestbook_id=" + guestbook_id + ", guestbook_password="
				+ guestbook_password + ", guestbook_content=" + guestbook_content + ", guestbook_group="
				+ guestbook_group + ", guestbook_parent=" + guestbook_parent + ", guestbook_date=" + guestbook_date
				+ ", guestbook_level=" + guestbook_level + "]";
	}
